...
_5G_NB_IoT_FILE::_5G_NB_IoT_FILE()
{
...
_5G_NB_IoT_FILE::_5G_NB_IoT_FILE(Stream &atserial, Stream &dserial) : _5G_NB_IoT_TCPIP(atserial, dserial)
{

}

bool _5G_NB_IoT_FILE::GetFliesSpace(unsigned long &free_bytes, unsigned long &total_bytes)
{
    char cmd[16]; 
...
bool _5G_NB_IoT_FILE::GetFilesList(char *list)
{
    char cmd[16];
...
bool _5G_NB_IoT_FILE::DeleteFiles(char *filename)
{
    char cmd[32],buf[32];
...
bool _5G_NB_IoT_FILE::UploadFiles(char *filename, char *u_file)
{
    char cmd[32],buf[32];
...
bool _5G_NB_IoT_FILE::DownloadFiles(char *filename, char *d_file)
{
    char cmd[32],buf[32];
...
bool _5G_NB_IoT_FILE::OpenFile(char *filename, Open_File_Mode_t mode, unsigned int &file_index)
{
    char cmd[32],buf[32];
...
bool _5G_NB_IoT_FILE::ReadFile(unsigned int file_index, char *read_data)
{
    char cmd[16],buf[8];
...
bool _5G_NB_IoT_FILE::WriteFile(unsigned int file_index, char *write_data)
{
    char cmd[32],buf[16];
...
bool _5G_NB_IoT_FILE::CloseFlie(unsigned int file_index)
{
    char cmd[16],buf[8];
...
bool _5G_NB_IoT_FILE::SetFilePointer(unsigned int file_index, unsigned int offset, Pointer_Mode_t p_mode)
{
    char cmd[32],buf[16];
...
bool _5G_NB_IoT_FILE::GetFilePointer(unsigned int file_index, unsigned int &offset)
{
    char cmd[32],buf[16];
...
bool _5G_NB_IoT_FILE::TruncateFile(unsigned int file_index)
{
    char cmd[16],buf[8];
