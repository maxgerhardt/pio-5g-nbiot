...
_5G_NB_IoT_HTTP::_5G_NB_IoT_HTTP()
{
...
_5G_NB_IoT_HTTP::_5G_NB_IoT_HTTP(Stream &atserial, Stream &dserial) : _5G_NB_IoT_SSL(atserial, dserial)
{

}

bool _5G_NB_IoT_HTTP::SetHTTPConfigParameters(unsigned int pdp_index, bool request_header, bool response_header, HTTP_Body_Data_Type_t type)
{
    char cmd[64], buf[32];
...
bool _5G_NB_IoT_HTTP::SetHTTPEnableSSL(unsigned int ssl_index)
{
    char cmd[64], buf[32];
    strcpy(cmd, HTTP_CONFIG_PARAMETER);
...
bool _5G_NB_IoT_HTTP::HTTPURL(char *url, Cmd_Status_t status)
{
    char cmd[32],buf[16];
...
bool _5G_NB_IoT_HTTP::HTTPGET(unsigned int timeout)
{
    char cmd[32], buf[16];
...
bool _5G_NB_IoT_HTTP::HTTPPOST(char *post_data, unsigned int timeout)
{
    char cmd[32], buf[16];
...
bool _5G_NB_IoT_HTTP::HTTTPPOSTFile(char *filename, unsigned int timeout)
{
    char cmd[64], buf[32];
...
bool _5G_NB_IoT_HTTP::HTTPRead(char *read_data, unsigned int timeout)
{
    char cmd[32], buf[16];
...
bool _5G_NB_IoT_HTTP::HTTPReadToFile(char *filename, unsigned int timeout)
{
    char cmd[64], buf[32];
