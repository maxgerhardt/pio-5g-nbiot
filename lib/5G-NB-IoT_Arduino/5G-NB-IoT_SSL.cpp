...
_5G_NB_IoT_SSL::_5G_NB_IoT_SSL(Stream &atserial, Stream &dserial) : _5G_NB_IoT_FILE(atserial, dserial)
{

}

bool _5G_NB_IoT_SSL::SetSSLParameters(unsigned int ssl_index, SSL_Version_t s_version, SSL_Cipher_Suites_t s_ciper, unsigned int negotiation_time)
{
    char cmd[64],buf[32];
...
bool _5G_NB_IoT_SSL::InitSSL(unsigned int ssl_index, char *ca_cert, char *client_cert, char *client_key, char *err_code)
{
...
bool _5G_NB_IoT_SSL::OpenSSLSocket(unsigned int pdp_index, unsigned int ssl_index, unsigned int socket_index, char *ip, unsigned int port, Access_Mode_t mode)
{
    char cmd[64],buf[64];
...
bool _5G_NB_IoT_SSL::SSLSocketSendData(unsigned int socket_index, char *ssl_send_data)
{
    char cmd[16], buf[8];
...
bool _5G_NB_IoT_SSL::SSLSocketRecvData(unsigned int socket_index, unsigned int ssl_recv_len, char *ssl_recv_data)
{
    char cmd[16],buf[16];
...
bool _5G_NB_IoT_SSL::CloseSSLSocket(unsigned int socket_index)
{
    char cmd[16],buf[16];
...
bool _5G_NB_IoT_SSL::QuerySSLSocketStatus(unsigned int socket_index, char *ssl_status)
{
    char cmd[16],buf[16];
...
SSL_Socket_Event_t _5G_NB_IoT_SSL::WaitCheckSSLSocketEvent(char *event, unsigned int timeout)
{
